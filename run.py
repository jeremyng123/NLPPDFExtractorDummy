...
with open('/Users/paulkasidit/Desktop/NLPPDFExtractorDummy/input/resume.pdf','rb')as f:
    doc = str(slate.PDF(f))

"""Loop to check if the path already exists, if not create a new folder with the output file inside"""
if not os.path.exists('/Users/paulkasidit/Desktop/NLPPDFExtractorDummy/output'):
    os.mkdir('/Users/paulkasidit/Desktop/NLPPDFExtractorDummy/output')

"""Writing the PDF output to a new file"""
path = '/Users/paulkasidit/Desktop/NLPPDFExtractorDummy/output'
file = 'output.txt'
